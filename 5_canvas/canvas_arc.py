...
cara = canvas.create_arc(ancho/2-radio_cara, alto/2-radio_cara, ancho/2+radio_cara, alto/2+radio_cara, start=angulo_inicial, extent=apertura, fill="yellow", outline="")
ojo = canvas.create_oval(ancho/2-radio_ojo, alto/4-radio_ojo, ancho/2+radio_ojo, alto/4+radio_ojo, fill="black", outline="")
